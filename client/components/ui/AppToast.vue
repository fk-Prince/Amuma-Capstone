        ...
        >
            ...
            >
                <div
                    ...
                    :key="toast.id"
                    class="pointer-events-auto relative overflow-hidden rounded-2xl border bg-white p-4 shadow-lg dark:bg-[#131C2E]"
                ...
                >
                    <div class="flex items-start gap-3">
                        ...
                        <button
                            type="button"
                            class="rounded-lg p-1 text-slate-400 transition hover:bg-slate-100 hover:text-slate-600 dark:text-gray-500 dark:hover:bg-white/10 dark:hover:text-gray-300"
