        ...
        >
            ...
            >
                <div
                    ...
                    aria-modal="true"
                    :aria-label="title"
                    class="w-full max-w-sm rounded-2xl bg-white p-5 shadow-2xl ring-1 ring-black/5 dark:bg-[#131C2E] dark:ring-white/10"
                >
                    ...
                    <div class="mt-5 flex justify-end gap-2.5">
                        <button
                            ...
                            class="rounded-lg border border-gray-200 px-4 py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50 dark:border-white/10 dark:text-gray-300 dark:hover:bg-white/5"
                            @click="emit('cancel')"
                        >
                            {{ cancelLabel }}
                        </button>
