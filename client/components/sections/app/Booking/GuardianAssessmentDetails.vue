    ...
    <div class="space-y-10">
        <section v-if="guardian">
            ...
            >
                ...
                <Field label="Phone Number" :value="formatPhone(guardian.phone_number)" />
            ...
            <div v-if="activeAssessment" class="space-y-8">
                <div class="space-y-4">
                    ...
                    >
                        ...
                        <Field
                            label="Speech"
                            :value="activeAssessment.speech"
                        />
                    </div>
                </div>

                <div
                    v-if="activeAssessment.life_system_profile"
                    class="space-y-4"
                >
                    <h5
                        class="text-xs font-semibold uppercase tracking-wide text-slate-400 dark:text-gray-500"
