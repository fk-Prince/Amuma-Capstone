            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <button
                            type="button"
                            class="rounded-lg p-1.5 text-slate-400 hover:bg-slate-100 dark:hover:bg-white/10"
                            @click="close"
                        >
                            <X class="h-4 w-4" />
                        </button>
                    ...
                    <div class="flex-1 overflow-y-auto px-5 py-4">
                        ...
                        <div class="space-y-2">
                            ...
                            >
                                ...
                                <span class="min-w-0">
                                    <span
                                        class="block text-sm font-medium text-slate-800 dark:text-gray-100"
                                    >
                                        {{ section.label }}
                                    </span>
                    ...
                    <div
                        class="flex justify-end gap-2 border-t border-slate-100 bg-slate-50 px-5 py-3 dark:bg-secondary dark:border-white/10"
                    >
                        <button
                            type="button"
                            class="rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-600 hover:bg-slate-50 dark:bg-secondary dark:text-gray-300 dark:border-white/10 dark:hover:bg-white/5"
                            @click="close"
                        >
                            Cancel
                        </button>
