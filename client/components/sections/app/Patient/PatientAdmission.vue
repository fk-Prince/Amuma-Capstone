<template>
    <div class="min-h-screen bg-slate-50 dark:bg-secondary">
        <div class="w-full mx-auto px-4 lg:px-8 py-8">
            <div v-if="loading" class="space-y-6">
                <div
                    class="rounded-2xl border border-primary-100 bg-white p-6 animate-pulse dark:bg-secondary"
                >
                    <div class="h-6 w-64 bg-slate-200 rounded"></div>
                    <div class="h-3 w-80 bg-slate-100 rounded mt-3 dark:bg-white/5"></div>
                </div>
                <div class="grid lg:grid-cols-3 gap-6">
                    <div
                        class="lg:col-span-2 rounded-2xl border border-primary-100 bg-white p-6 animate-pulse h-48 dark:bg-secondary"
                    ></div>
                    <div
                        class="rounded-2xl border border-primary-100 bg-white p-6 animate-pulse h-48 dark:bg-secondary"
                    ></div>
                </div>
            </div>
            ...
            <div
                v-else-if="!patient"    
                class="rounded-2xl border border-dashed border-slate-300 p-12 text-center text-slate-400 dark:border-white/15"
            >
            ...
            <template v-else>
                <div class="grid lg:grid-cols-3 gap-6">
                    <div class="lg:col-span-2 space-y-6">
                        <section>
                            ...
                            <button
                                ...
                                "
                                type="button"
                                class="w-full text-left rounded-2xl bg-white border border-primary-100 shadow-[0_0_40px_rgba(10,40,87,0.06)] p-6 hover:bg-primary-50/40 transition dark:bg-secondary"
                            >
                                <div
                                ...
                                <div v-if="totalStayDays !== null" class="mt-5">
                                    <div
                                        class="h-1.5 rounded-full bg-slate-100 overflow-hidden dark:bg-white/5"
                                    >
                                        <div
                            ...
                            <div
                                v-else
                                class="rounded-2xl border border-dashed border-slate-300 p-8 text-center text-sm text-slate-400 dark:border-white/15"
                            >
                    ...
                    <aside class="space-y-6">
                        <div
                            class="rounded-2xl bg-white border border-primary-100 shadow-[0_0_40px_rgba(10,40,87,0.06)] p-5 dark:bg-secondary"
                        >
                            <div class="grid grid-cols-2 gap-3">
                                ...
                                <div
                                    class="rounded-xl bg-slate-50 border border-slate-100 p-4 dark:bg-secondary dark:border-white/10"
                                >
                                    <p
                                        class="text-[10px] uppercase tracking-wide text-muted font-semibold dark:text-gray-400"
                                    >
                        ...
                        <section>
                            ...
                            <div v-else class="space-y-4">
                                <div
                                    ...
                                    class="rounded-2xl bg-white border border-primary-100 shadow-[0_0_40px_rgba(10,40,87,0.06)] p-6 hover:bg-primary-50/40 transition dark:bg-secondary"
                                >
                                    <div
                                        class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3"
                                    >
