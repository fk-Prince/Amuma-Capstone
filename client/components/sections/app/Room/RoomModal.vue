        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <div
                            class="sticky top-0 z-10 flex items-center justify-between gap-4 rounded-t-2xl border-b border-gray-100 bg-white/95 px-6 py-5 backdrop-blur dark:border-white/10"
                        >
                        ...
                        <form @submit.prevent="onSubmit" class="p-6">
                            <div class="space-y-6">
                                ...
                                >
                                    ...
                                    >
                                        <template #suffix>
                                            <span
                                                class="border-l border-gray-200 bg-gray-50 px-3 py-2.5 text-sm font-medium text-gray-500 dark:bg-white/5 dark:text-gray-400 dark:border-white/10"
                                            >
                                                Floor
                                            </span>
                                        </template>
                            ...
                            >
                                <button
                                    type="button"
                                    @click="emit('close')"
                                    class="rounded-xl border border-gray-200 px-5 py-2.5 text-sm font-medium text-gray-600 transition hover:bg-gray-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-gray-300 dark:text-gray-300 dark:border-white/10 dark:hover:bg-white/5"
                                >
                                    Cancel
                                </button>
