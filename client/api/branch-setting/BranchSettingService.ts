...
class BranchSettingService extends BaseService {
    private static instance: BranchSettingService;
    ...
    public static getInstance(): BranchSettingService {
        if (!BranchSettingService.instance) {
            BranchSettingService.instance = new BranchSettingService();
        }
        return BranchSettingService.instance;
    }
    ...
    private get resource(): string {
        ...
        return `${backend}/api/settings`;
    }
}

export const branchSettingService = BranchSettingService.getInstance();
