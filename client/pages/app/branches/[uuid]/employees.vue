    ...
    <div class="w-full max-w-8xl mx-auto p-4 md:p-6 space-y-5">
        ...
        >
            <div>
                ...
                <EmployeeSearch
                    @addEmployee="addEmployeeTab = !addEmployeeTab"
                    v-model="searchData"
        ...
        <EmployeeAdd v-else @back="addEmployeeTab = false" />
    </div>
</template>
...
import EmployeeAdd from "~/components/sections/app/Employee/EmployeeAdd.vue";
